...
from opiniones.forms import LoginForm, OpinionForm
from opiniones.models import Opinion


@require_GET
def index(request):
    """ Página principal, muestra las opiniones ordenadas por fecha """
...
def nueva_opinion(request):
    """ Muestra el formulario de nueva opinión (GET) o
        recibe el formulario y añade la opinión (POST)
    """
    if request.method == "GET":
        form = OpinionForm()
